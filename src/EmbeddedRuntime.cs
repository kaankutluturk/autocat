...
static class EmbeddedRuntime {
 ...
 internal const string ResourceName="AutoCat.Runtime.autocat.runtime.100.dll";
 internal static string Extract(){string dir=Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),"AutoCat","runtime");Directory.CreateDirectory(dir);string target=Path.Combine(dir,"autocat.runtime.100.dll");
